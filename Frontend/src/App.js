...
import DonationManagement from "./Component/Pages/AddDonation";
import Donation from "./Component/Pages/Donation";
import CustomerDonation from "./Component/Pages/CustomerDonation";
import VendorDonationMealForm from "./Component/Pages/VendorDonationMealForm";
import VendorViewDonationMealDetails from "./Component/Pages/VendorViewDonationMealDetails";
function App() {
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/customer/donate/:vendorId" element={<CustomerDonation />} />
        ...
        <Route path="/add-donation-meal" element={<VendorDonationMealForm />} />
        <Route path="/vendor/view-donation-meal-details" element={<VendorViewDonationMealDetails/>} />
