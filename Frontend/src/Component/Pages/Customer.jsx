                ...
                <>
                    ...
                    <div className="container">
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                            ...
                            <div className="col">
                                <div className="card h-100" onClick={() => navigate("/donation")}>
                                    <img
                                        src="https://cdn-icons-png.flaticon.com/512/3081/3081984.png"
                                        className="card-img-top"
                                        alt="Donate"
                                    />
                                    <div className="card-body">
                                        <h5 className="card-title">Donate Meals</h5>
                                        <p className="card-text">Donate meals to NGOs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
